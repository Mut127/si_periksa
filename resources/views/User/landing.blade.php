...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">PERIKSA</h4>
                    <p class="italic mt-0 text-white">Pengaduan Kritik dan Saran</p>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.logout') }}" style="text-decoration: underline">{{ Auth::guard('mahasiswa')->user()->nama }}</a>
                        </li>
                    </ul>
                    @else
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <button class="btn text-white" type="button" class="btn btn-primary" data-toggle="modal" data-target="#loginModal">Masuk</button>
                        </li>
                        <li class="nav-item">
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Pengaduan dan Kritik Saran Mahasiswa</h2>
        <p class="italic text-white mb-5">Sampaikan Pengaduan dan Kritik Saran Anda langsung </p>
    </div>
